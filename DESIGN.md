...
- Plan revisions retain at most 12 immutable content records per plan, and plan reviews retain at most 24 immutable records per plan. A revision clears activation. Activating a versioned plan requires owner attestation plus an immutable ACCEPT review for that exact revision and the current preview board version and cache key.
